const MobileSearchButton = ({blok, onClick, label }) => {
  return (
    <>
    <div className="md:hidden relative w-full">
    <div className='flex items-center flex-1 p-2 truncate' onClick={onClick}>
  ...
  className="absolute top-full mt-4 -mx-3 w-[calc(100%+1.5rem)] py-3 font-medium tracking-wide text-white uppercase rounded-md bg-secondary">
  {blok.submit_text}
</button>
    </div>
