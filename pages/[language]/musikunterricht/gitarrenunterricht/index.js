...
export async function getServerSideProps({ params }) {
  ...
  const storyFetchResult = await fetchStoryData(StoryblokService, language, 'musikunterricht/gitarrenunterricht');
...
function GitarrenunterrichtPage({ story, language, instrument, instruments, _online, recommendations }) {
